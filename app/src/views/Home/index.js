...
import { Container, Main, Middle, BtnEdition, Content, Image, Text, Footer, CardContent, LinkMenu } from './styles';
import HeadIcon from '../../components/HeadIcon';

const useElementOnScreen = (options, isVisibleDefault) => {
    const containerRef = React.useRef(null)
    const [isVisible, setIsVisible] = useState(isVisibleDefault ? isVisibleDefault : false);
...
function Home() {
    ...
    return (
        <Container >
            ...
            <Main>
                <ObserveableComponent onVisible={() => setWhatSelected(0)} isVisibleDefault={true}>
